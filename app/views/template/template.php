...
<body>
	<div class="containerTopo">
		<div class="menuTopo">
			<div class="logo">Sistema MVC</div>
			<div class="opcoesMenu">
				<ul>
					<li><a href="<?= BASE_URL ?>produtos/" alt="Produtos" title="Produtos">Produtos</a></li>
					...
					<li><a href="" id="btnLogin" alt="Login" title="Login">Login</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="containerConteudo">
		<?php $this->loadTemplateInView($viewName, $viewData); ?>
	</div>
